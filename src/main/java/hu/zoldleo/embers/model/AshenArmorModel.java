...
public class AshenArmorModel extends HumanoidModel<LivingEntity> {
	public static final ModelLayerLocation ASHEN_ARMOR_HEAD = new ModelLayerLocation(Embers.res("ashen_armor"), "head");
	public static final ModelLayerLocation ASHEN_ARMOR_CHEST = new ModelLayerLocation(Embers.res("ashen_armor"), "chest");
	public static final ModelLayerLocation ASHEN_ARMOR_LEGS = new ModelLayerLocation(Embers.res("ashen_armor"), "legs");
	public static final ModelLayerLocation ASHEN_ARMOR_FEET = new ModelLayerLocation(Embers.res("ashen_armor"), "feet");
	...
	public AshenArmorModel(ModelPart root) {
		super(root);
	...
	public static void init(EntityRendererProvider.Context context) {
		for (var slot : EquipmentSlot.values()) {
			ModelPart mesh = switch (slot) {
                case HEAD -> context.bakeLayer(ASHEN_ARMOR_HEAD);
                case CHEST -> context.bakeLayer(ASHEN_ARMOR_CHEST);
                case LEGS -> context.bakeLayer(ASHEN_ARMOR_LEGS);
                default -> context.bakeLayer(ASHEN_ARMOR_FEET);
            };
            ARMOR_MODELS.put(slot, new AshenArmorModel(mesh));
		}
	}
