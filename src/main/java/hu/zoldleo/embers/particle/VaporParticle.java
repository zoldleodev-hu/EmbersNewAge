...
public class VaporParticle extends TextureSheetParticle {
	...
	public static class Provider implements ParticleProvider.Sprite<VaporParticleOptions> {
		public TextureSheetParticle createParticle(@NotNull VaporParticleOptions pType, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
