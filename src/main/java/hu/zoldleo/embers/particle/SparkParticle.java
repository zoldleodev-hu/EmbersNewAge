...
public class SparkParticle extends TextureSheetParticle {
	...
	public static class Provider implements ParticleProvider.Sprite<SparkParticleOptions> {
		public TextureSheetParticle createParticle(@NotNull SparkParticleOptions pType, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
