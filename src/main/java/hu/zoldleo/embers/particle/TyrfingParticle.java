...
public class TyrfingParticle extends TextureSheetParticle {
	...
	public static class Provider implements ParticleProvider.Sprite<TyrfingParticleOptions> {
		public TextureSheetParticle createParticle(@NotNull TyrfingParticleOptions pType, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
