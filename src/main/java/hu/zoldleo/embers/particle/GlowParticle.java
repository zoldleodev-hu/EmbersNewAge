...
public class GlowParticle extends TextureSheetParticle {
	...
	public static class Provider implements ParticleProvider.Sprite<GlowParticleOptions> {
		public TextureSheetParticle createParticle(@NotNull GlowParticleOptions pType, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
