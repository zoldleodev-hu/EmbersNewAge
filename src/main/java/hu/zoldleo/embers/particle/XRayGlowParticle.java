...
public class XRayGlowParticle extends TextureSheetParticle {
	...
	public static class Provider implements ParticleProvider.Sprite<XRayGlowParticleOptions> {
		public TextureSheetParticle createParticle(@NotNull XRayGlowParticleOptions pType, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
