...
public class ConfigManager {
    ...
    public static ConfigValue<Boolean> EASY_ALCHEMY_RECIPES;
	...
	public static void registerClientConfigs(ModContainer modContainer) {
        ...
        modContainer.registerConfig(ModConfig.Type.CLIENT, CLIENT.build());
	}

	public static void registerCommonConfigs(ModContainer modContainer) {
	...
	public static void registerServerConfigs(ModContainer modContainer) {
        ModConfigSpec.Builder SERVER = new ModConfigSpec.Builder();

        EASY_ALCHEMY_RECIPES = SERVER.comment("Determines if alchemy recipes match without the correct aspectus order.").define("easyAlchemyRecipes", false);

        modContainer.registerConfig(ModConfig.Type.SERVER, SERVER.build());
	}
}