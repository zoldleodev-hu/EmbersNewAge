...
public class ToolExplosion extends Explosion {
	 ...
	 */
	public void finalizeExplosion(boolean pSpawnParticles) { // TODO: Lootparam mixin and flag
				...
				if (!blockstate.isAir()) {
					...
					if (blockstate.canDropFromExplosion(this.level, blockpos, this)) {
                        if (this.level instanceof ServerLevel serverlevel) {
							...
							blockstate.getDrops(lootparams$builder).forEach(stack -> addOrAppendStack(objectarraylist, stack, blockpos1));
						}
					}
