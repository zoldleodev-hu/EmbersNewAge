...
public class EmbersColors implements ResourceManagerReloadListener {
	...
	public static ResourceLocation CUSTOM_ID = Embers.res("custom");

	public static ResourceLocation EMBER_ID = Embers.res("ember");
	public static int EMBER_ABGR = 0xFF1040FF;
	public static Vector3f EMBER = new Vector3f(255.0F / 255.0F, 64.0F / 255.0F, 16.0F / 255.0F);
	public static ResourceLocation EMBER_INVERTED_ID = Embers.res("ember_inverted");
	public static Vector3f EMBER_INVERTED = new Vector3f(EMBER.z, EMBER.y, EMBER.x);
	public static ResourceLocation OVERHEAT_ID = Embers.res("hearth_coil_overheat");
	...
	public static ResourceLocation GLIMMER_PROJECTILE_ID = Embers.res("glimmer_projectile");
	...
	public static ResourceLocation PIPE_CLOGGED_ID = Embers.res("pipe_clogged");
	...
	public static ResourceLocation PIPE_FLOWING_ID = Embers.res("pipe_flowing");
	...
	public static int getColorFromTexture(ResourceManager manager, String name) throws FileNotFoundException, IOException {
		NativeImage image = NativeImage.read(manager.getResource(Embers.res("textures/colors/" + name + ".png")).orElseThrow(FileNotFoundException::new).open());
