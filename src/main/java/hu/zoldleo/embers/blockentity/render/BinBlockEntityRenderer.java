...
public class BinBlockEntityRenderer implements BlockEntityRenderer<BinBlockEntity> {
	...
	@Override
	public void render(@NotNull BinBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
