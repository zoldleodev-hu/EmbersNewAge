...
public class CopperChargerBlockEntityRenderer implements BlockEntityRenderer<CopperChargerBlockEntity> {
	...
	@Override
	public void render(@NotNull CopperChargerBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        //render items
