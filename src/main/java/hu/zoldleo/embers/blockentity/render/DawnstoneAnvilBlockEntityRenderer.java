...
public class DawnstoneAnvilBlockEntityRenderer implements BlockEntityRenderer<DawnstoneAnvilBlockEntity> {
	...
	@Override
	public void render(@NotNull DawnstoneAnvilBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
    ...
    @Override
    public @NotNull AABB getRenderBoundingBox(DawnstoneAnvilBlockEntity tile) {
