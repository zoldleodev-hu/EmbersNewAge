...
import hu.zoldleo.embers.blockentity.EntropicEnumeratorBlockEntity.Cubie;
...
public class EntropicEnumeratorBlockEntityRenderer implements BlockEntityRenderer<EntropicEnumeratorBlockEntity> {
	...
	public EntropicEnumeratorBlockEntityRenderer(BlockEntityRendererProvider.Context ignored) {
	}

	@Override
	public void render(EntropicEnumeratorBlockEntity blockEntity, float partialTick, PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
