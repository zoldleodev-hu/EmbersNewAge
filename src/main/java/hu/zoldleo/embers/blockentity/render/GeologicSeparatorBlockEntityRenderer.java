...
public class GeologicSeparatorBlockEntityRenderer implements BlockEntityRenderer<GeologicSeparatorBlockEntity> {
	...
	@Override
	public void render(GeologicSeparatorBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        //render fluid
