...
import hu.zoldleo.embers.blockentity.AtmosphericBellowsBlockEntity;
...
public class AtmosphericBellowsBlockEntityRenderer implements BlockEntityRenderer<AtmosphericBellowsBlockEntity> {
	...
	@Override
	public void render(AtmosphericBellowsBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
