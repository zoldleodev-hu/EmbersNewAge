...
public class AlchemyPedestalTopBlockEntityRenderer implements BlockEntityRenderer<AlchemyPedestalTopBlockEntity> {
	...
	@Override
	public void render(@NotNull AlchemyPedestalTopBlockEntity blockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
