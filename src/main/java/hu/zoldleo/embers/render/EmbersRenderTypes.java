...
public class EmbersRenderTypes extends RenderType {
	...
	public static final RenderStateShard.ShaderStateShard PTLC_SHADER = new RenderStateShard.ShaderStateShard(GameRenderer::getPositionColorTexLightmapShader);
	public static final RenderStateShard.ShaderStateShard PTCN_SHADER = new RenderStateShard.ShaderStateShard(GameRenderer::getRendertypeCloudsShader);
	...
	public static final RenderType CRYSTAL = create(
			...
			.setTextureState(new RenderStateShard.TextureStateShard(Embers.res("textures/block/crystal_material.png"), false, false))
	...
	public static final RenderType FIELD_CHART = create(
			...
			RenderType.CompositeState.builder()
			.setShaderState(ADDITIVE_SHADER)
			.setTextureState(new RenderStateShard.TextureStateShard(Embers.res("textures/block/field_square.png"), false, false))
			.setTransparencyState(LIGHTNING_TRANSPARENCY)
			.setCullState(NO_CULL)
			//.setOutputState(TRANSLUCENT_TARGET)
			.createCompositeState(false));
	...
	public static final RenderType BEAM = create(
			...
			.setTextureState(new RenderStateShard.TextureStateShard(Embers.res("textures/entity/alchemy_circle.png"), false, false))
			.setTransparencyState(LIGHTNING_TRANSPARENCY)
			.setCullState(NO_CULL)
	...
	public static final RenderType HEAT_BAR_ENDS = create(
			...
			.setTextureState(new RenderStateShard.TextureStateShard(Embers.res("textures/gui/heat_bar.png"), false, false))
	...
	public static final RenderType NOTE_BACKGROUND = getNote(Embers.res("textures/gui/alchemical_note.png"));
	public static final RenderType NOTE_PEDESTAL = getNote(Embers.res("textures/gui/alchemical_note_pedestal.png"));
	...
	public static ResourceLocation MITHRIL_REFLECTION = Embers.res("textures/misc/mithril_reflection.png");
