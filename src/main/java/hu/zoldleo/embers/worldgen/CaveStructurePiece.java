...
public class CaveStructurePiece extends PoolElementStructurePiece {
	...
	public CaveStructurePiece(StructureTemplateManager pStructureTemplateManager, StructurePoolElement pElement, BlockPos pPosition, int pGroundLevelDelta, Rotation pRotation, BoundingBox pBox, Structure.GenerationContext context, int maxHeight) {
		super(pStructureTemplateManager, pElement, pPosition, pGroundLevelDelta, pRotation, pBox, LiquidSettings.IGNORE_WATERLOGGING);
		this.context = context;
		this.maxHeight = maxHeight;
	}

	@Override
	public void postProcess(@NotNull WorldGenLevel worldGenLevel, @NotNull StructureManager structureManager, @NotNull ChunkGenerator chunkGenerator, @NotNull RandomSource randomSource, @NotNull BoundingBox boundingBox, @NotNull ChunkPos chunkPos, @NotNull BlockPos pos) {
