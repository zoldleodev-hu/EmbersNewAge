...
import hu.zoldleo.embers.research.subtypes.ResearchFakePage;
import hu.zoldleo.embers.research.subtypes.ResearchShowItem;
import hu.zoldleo.embers.research.subtypes.ResearchShowItem.DisplayItem;
...
public class ResearchManager {
	public static final ResourceLocation PLAYER_RESEARCH = Embers.res("research");
	public static final ResourceLocation PAGE_ICONS = Embers.res("textures/gui/codex_pageicons.png");
	public static final double PAGE_ICON_SIZE = 48;
	public static List<ResearchCategory> researches = new ArrayList<>();
	public static HashMap<Item, ResearchBase> researchByItem = new HashMap<>();
	...
	public static void sendCheckmark(ResearchBase research, boolean checked) {
		PacketDistributor.sendToServer(new MessageResearchTick(research.id, checked));
	}
	...
	public static void initResearches() {
		...
		ItemStack fullJar = EmberStorageItem.withFill(RegistryManager.EMBER_JAR.get(), RegistryManager.EMBER_JAR.get().getCapacity());
