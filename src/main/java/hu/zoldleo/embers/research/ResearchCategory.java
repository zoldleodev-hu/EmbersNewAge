...
public class ResearchCategory {
	...
	public double v;
	public ResourceLocation texture = Embers.res("textures/gui/codex_index.png");
	public ResourceLocation background = Embers.res("textures/gui/codex_category.png");
