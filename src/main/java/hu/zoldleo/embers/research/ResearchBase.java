...
public class ResearchBase {
	...
	public Ingredient lookupIngredient;
	public int x;
	public int y;
	...
	public ResourceLocation background = Embers.res("textures/gui/codex_normal.png");
	...
	public ResearchBase(String location, ItemStack icon, double x, double y) {
		this(Embers.res(location), icon, x, y);
	}
	...
	public List<ResearchBase> getAllRequirements() {
        ...
        List<ResearchBase> requirements = new ArrayList<>(ancestors);
