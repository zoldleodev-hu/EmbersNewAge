...
public class EmbersConfiguredFeatures {
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_LEAD_KEY = ResourceKey.create(Registries.CONFIGURED_FEATURE, Embers.res("ore_lead"));
	public static final ConfiguredFeature<OreConfiguration, ?> ORE_LEAD = new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(ORE_LEAD_TARGET_LIST.get(), 8));
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_SILVER_KEY = ResourceKey.create(Registries.CONFIGURED_FEATURE, Embers.res("ore_silver"));
	public static final ConfiguredFeature<OreConfiguration, ?> ORE_SILVER = new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(ORE_SILVER_TARGET_LIST.get(), 6, 0.25F));
