...
public class EmbersLang extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		add("itemGroup." + Embers.MODID, "Embers New Age");
	...
	public void addSubtitle(DeferredHolder<SoundEvent, SoundEvent> soundEvent, String subtitle) {
	...
	public void addAugment(Holder<IAugment> augment, String name) {
		addAugment(augment, name, false);
	}

	public void addAugment(Holder<IAugment> augment, String name, boolean singleLevel) {
        augment.unwrapKey().ifPresent(key -> add(Embers.MODID + ".tooltip.augment." + key.location().toLanguageKey(), name + (singleLevel ? "" : " %s")));
	}
