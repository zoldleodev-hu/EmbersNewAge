...
public class EmbersPlacedFeatures {
	...
	public static final ResourceKey<PlacedFeature> ORE_LEAD_KEY = ResourceKey.create(Registries.PLACED_FEATURE, Embers.res("ore_lead_placer"));
	...
	public static final ResourceKey<PlacedFeature> ORE_SILVER_KEY = ResourceKey.create(Registries.PLACED_FEATURE, Embers.res("ore_silver_placer"));
