...
public class EmbersBlockLootTables extends BlockLootSubProvider {
	public EmbersBlockLootTables(HolderLookup.Provider provider) {
	...
	protected void generate() {
		add(RegistryManager.LEAD_ORE.get(), (block) -> createOreDrop(block, RegistryManager.RAW_LEAD.get()));
		add(RegistryManager.DEEPSLATE_LEAD_ORE.get(), (block) -> createOreDrop(block, RegistryManager.RAW_LEAD.get()));
		dropSelf(RegistryManager.RAW_LEAD_BLOCK.get());
		dropSelf(RegistryManager.LEAD_BLOCK.get());

		add(RegistryManager.SILVER_ORE.get(), (block) -> createOreDrop(block, RegistryManager.RAW_SILVER.get()));
		add(RegistryManager.DEEPSLATE_SILVER_ORE.get(), (block) -> createOreDrop(block, RegistryManager.RAW_SILVER.get()));
