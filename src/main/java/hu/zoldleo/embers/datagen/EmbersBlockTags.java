...
public class EmbersBlockTags extends BlockTagsProvider {
	public static final TagKey<Block> EMITTER_CONNECTION = BlockTags.create(Embers.res("emitter_connection"));
	public static final TagKey<Block> EMITTER_CONNECTION_FLOOR = BlockTags.create(Embers.res("emitter_connection/floor"));
	public static final TagKey<Block> EMITTER_CONNECTION_CEILING = BlockTags.create(Embers.res("emitter_connection/ceiling"));

	public static final TagKey<Block> ITEM_PIPE_CONNECTION = BlockTags.create(Embers.res("item_pipe_connection"));
	public static final TagKey<Block> ITEM_PIPE_CONNECTION_TOGGLEABLE = BlockTags.create(Embers.res("item_pipe_connection/toggleable"));

	public static final TagKey<Block> FLUID_PIPE_CONNECTION = BlockTags.create(Embers.res("fluid_pipe_connection"));
	public static final TagKey<Block> FLUID_PIPE_CONNECTION_TOGGLEABLE = BlockTags.create(Embers.res("fluid_pipe_connection/toggleable"));

	public static final TagKey<Block> MECH_CORE_PROXYABLE = BlockTags.create(Embers.res("mech_core_proxyable"));
	public static final TagKey<Block> MECH_CORE_PROXYABLE_BOTTOM = BlockTags.create(Embers.res("mech_core_proxyable/bottom"));
	public static final TagKey<Block> MECH_CORE_PROXYABLE_TOP = BlockTags.create(Embers.res("mech_core_proxyable/top"));

	public static final TagKey<Block> HEAT_SOURCES = BlockTags.create(Embers.res("heat_sources"));

	public static final TagKey<Block> RESERVOIR_EXPANSION = BlockTags.create(Embers.res("reservoir_expansion"));
	public static final TagKey<Block> RESERVOIR_END = BlockTags.create(Embers.res("reservoir_end"));
	public static final TagKey<Block> RESERVOIR_CAP = BlockTags.create(Embers.res("reservoir_cap"));

	public static final TagKey<Block> CHAMBER_CONNECTION = BlockTags.create(Embers.res("chamber_connection"));

	public static final TagKey<Block> DIAL = BlockTags.create(Embers.res("dial"));

	public static final TagKey<Block> EMBER_WRONG_INPUT_HINTER = BlockTags.create(Embers.res("wrong_input_hinter"));

	public static final TagKey<Block> MINABLE_WITH_PICKAXE_SHOVEL = BlockTags.create(Embers.res("mineable/pickaxe_shovel"));
	public static final TagKey<Block> MINABLE_WITH_HAMMER = BlockTags.create(Embers.res("mineable/hammer"));

	public static final TagKey<Block> NEEDS_LEAD_TOOL = BlockTags.create(Embers.res("needs_lead_tool"));
	public static final TagKey<Block> NEEDS_TYRFING = BlockTags.create(Embers.res("needs_tyrfing"));
	public static final TagKey<Block> NEEDS_SILVER_TOOL = BlockTags.create(Embers.res("needs_silver_tool"));
	public static final TagKey<Block> NEEDS_DAWNSTONE_TOOL = BlockTags.create(Embers.res("needs_dawnstone_tool"));
	public static final TagKey<Block> NEEDS_CLOCKWORK_TOOL = BlockTags.create(Embers.res("needs_clockwork_tool"));
	public static final TagKey<Block> NEEDS_CLOCKWORK_HAMMER = BlockTags.create(Embers.res("needs_clockwork_hammer"));

    public static final TagKey<Block> INCORRECT_FOR_LEAD_TOOL = BlockTags.create(Embers.res("incorrect_for_lead_tool"));
    public static final TagKey<Block> INCORRECT_FOR_TYRFING = BlockTags.create(Embers.res("incorrect_for_tyrfing"));
    public static final TagKey<Block> INCORRECT_FOR_SILVER_TOOL = BlockTags.create(Embers.res("incorrect_for_silver_tool"));
    public static final TagKey<Block> INCORRECT_FOR_DAWNSTONE_TOOL = BlockTags.create(Embers.res("incorrect_for_dawnstone_tool"));
    public static final TagKey<Block> INCORRECT_FOR_CLOCKWORK_TOOL = BlockTags.create(Embers.res("incorrect_for_clockwork_tool"));
    public static final TagKey<Block> INCORRECT_FOR_CLOCKWORK_HAMMER = BlockTags.create(Embers.res("incorrect_for_clockwork_hammer"));

	public static final TagKey<Block> EMBER_CONSUMPTION_UPGRADEABLE = BlockTags.create(Embers.res("upgradeable_with/consumption_multiplier"));
	public static final TagKey<Block> EMBER_PRODUCTION_UPGRADEABLE = BlockTags.create(Embers.res("upgradeable_with/production_multiplier"));
	public static final TagKey<Block> SPEED_UPGRADEABLE = BlockTags.create(Embers.res("upgradeable_with/speed_multiplier"));

	//tags shared with items
	public static final TagKey<Block> WORLD_BOTTOM = BlockTags.create(Embers.res("world_bottom"));
	//public static final TagKey<Block> SNOW = BlockTags.create(Embers.res("snow"));

	public static final TagKey<Block> PRISTINE_COPPER = BlockTags.create(Embers.res("pristine_copper"));
	public static final TagKey<Block> EXPOSED_COPPER = BlockTags.create(Embers.res("exposed_copper"));
	public static final TagKey<Block> WEATHERED_COPPER = BlockTags.create(Embers.res("weathered_copper"));
	public static final TagKey<Block> OXIDIZED_COPPER = BlockTags.create(Embers.res("oxidized_copper"));

	public static final TagKey<Block> LEAD_ORE = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "ores/lead"));
	public static final TagKey<Block> RAW_LEAD_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/raw_lead"));

	public static final TagKey<Block> SILVER_ORE = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "ores/silver"));
	public static final TagKey<Block> RAW_SILVER_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/raw_silver"));

	public static final TagKey<Block> LEAD_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/lead"));
	public static final TagKey<Block> SILVER_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/silver"));
	public static final TagKey<Block> DAWNSTONE_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/dawnstone"));
	public static final TagKey<Block> MITHRIL_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/dwarven_mithril"));

	public static final TagKey<Block> CRYSTAL_SEEDS = BlockTags.create(Embers.res("crystal_seeds"));
	public static final TagKey<Block> COPPER_SEED = BlockTags.create(Embers.res("crystal_seeds/copper"));
	public static final TagKey<Block> IRON_SEED = BlockTags.create(Embers.res("crystal_seeds/iron"));
	public static final TagKey<Block> GOLD_SEED = BlockTags.create(Embers.res("crystal_seeds/gold"));
	public static final TagKey<Block> LEAD_SEED = BlockTags.create(Embers.res("crystal_seeds/lead"));
	public static final TagKey<Block> SILVER_SEED = BlockTags.create(Embers.res("crystal_seeds/silver"));
	public static final TagKey<Block> NICKEL_SEED = BlockTags.create(Embers.res("crystal_seeds/nickel"));
	public static final TagKey<Block> TIN_SEED = BlockTags.create(Embers.res("crystal_seeds/tin"));
	public static final TagKey<Block> ALUMINUM_SEED = BlockTags.create(Embers.res("crystal_seeds/aluminum"));
	public static final TagKey<Block> ZINC_SEED = BlockTags.create(Embers.res("crystal_seeds/zinc"));
	public static final TagKey<Block> PLATINUM_SEED = BlockTags.create(Embers.res("crystal_seeds/platinum"));
	public static final TagKey<Block> URANIUM_SEED = BlockTags.create(Embers.res("crystal_seeds/uranium"));
	public static final TagKey<Block> DAWNSTONE_SEED = BlockTags.create(Embers.res("crystal_seeds/dawnstone"));
	public static final TagKey<Block> MITHRIL_SEED = BlockTags.create(Embers.res("crystal_seeds/dwarven_mithril"));

	//tags not used in this class
	public static final TagKey<Block> BRONZE_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/bronze"));
	public static final TagKey<Block> NICKEL_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/nickel"));
	public static final TagKey<Block> TIN_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/tin"));
	public static final TagKey<Block> ALUMINUM_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/aluminium"));
	public static final TagKey<Block> ELECTRUM_BLOCK = BlockTags.create(ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/electrum"));
	...
	protected void addTags(HolderLookup.@NotNull Provider provider) {
		...
		//tag(BlockTags.SNOW).add(Blocks.SNOW_BLOCK);
        ...
        tag(BlockTags.CAULDRONS).add(RegistryManager.FLUID_VESSEL.get());
	}
	...
	public IntrinsicTagAppender<Block> upgradeTag(Block upgrade) {
		...
		return tag(BlockTags.create(Embers.res("upgradeable_with/" + upgradeLoc.getNamespace() + "/" + upgradeLoc.getPath())));
	}
}