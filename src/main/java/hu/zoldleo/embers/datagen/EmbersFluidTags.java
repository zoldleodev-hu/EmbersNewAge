...
public class EmbersFluidTags extends FluidTagsProvider {
	...
	public static final TagKey<Fluid> WATERY = FluidTags.create(Embers.res("watery"));
	...
	//ingot tooltips
	public static final TagKey<Fluid> INGOT_TOOLTIP = FluidTags.create(Embers.res("ingot_tooltip"));
